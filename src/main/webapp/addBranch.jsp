...
<body class="form-login-body">
	...
	<%
	String branchAdd = (String) request.getAttribute("branchAdd");
	if (branchAdd != null) {
	%>
	<script type="text/javascript">
		var branchAdd ="<%=branchAdd%>";
		if(branchAdd!==null){
			alert(branchAdd) ;
		}
    ...
    document.getElementById('email').addEventListener('input', function() {
        var email = this.value.toLowerCase(); // Convert email to lowercase
                ...
                emailError.style.display = 'none';
                        ...
                        alert("<%=message%>
								...
								<div class="button" style="width: 640px;">
									<a href="bankLogin.jsp"><p class="arrow">Already have
											an account ?</p> </a>
								</div>
