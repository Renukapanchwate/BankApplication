...
<body data-spy="scroll" data-target=".site-navbar-target"
	...
	<div class="site-wrap">
				...
				<div class="row align-items-center">
					...
					<div class="col-6 col-xl-2">
						<h1 class="mb-0 site-logo">
							<a href="index.html" class="h2 mb-0">BankingPortal<span
					...
					<div class="col-12 col-md-10 d-none d-xl-block">
						<nav class="site-navigation position-relative text-right"
							...
							<ul
								...
								<li class="has-children"><a href="#" class="nav-link">Bank</a>
									<ul class="dropdown">

										<li><a href="addBranch.jsp" class="nav-link">Add
												Branch</a></li>
										<li><a href="displayB.jsp" class="nav-link">Display</a></li>
										<li><a href="changePassword.jsp" class="nav-link">Change
												Password</a></li>
										<%-- 	<li><a href="updateBank.jsp" class="nav-link">Update
												BAnk</a></li>  --%>
								...
								<li class="has-children"><a href="#" class="nav-link">Branch</a>
									<ul class="dropdown">

										<li><a href="displayAllBranches.jsp" class="nav-link">Display
												Branches</a> <li><a href="findBranch.jsp" class="nav-link">Find Branch</a></li>

									</ul></li>

								<li class="has-children"><a href="#" class="nav-link">User</a>
									<ul class="dropdown">

										<li><a href="addUser.jsp" class="nav-link">Add User</a></li>
										<li><a href="DisplayAllUser.jsp" class="nav-link">display User</a></li>
										<li><a href="loginUser.jsp" class="nav-link">find
												User</a></li>

									</ul></li>
								<li class="has-children"><a href="#" class="nav-link">Transaction</a>
									<ul class="dropdown">

										<li><a href="loginUser.jsp" class="nav-link">WithDraw</a></li>
										<li><a href="loginUser.jsp" class="nav-link">Deposit</a></li>
										<li class="has-children"><a href="#" class="nav-link">Transfer</a>
											<ul class="dropdown">

												<li><a href="loginUser.jsp" class="nav-link">In
														Same Branch</a></li>
												<li><a href="loginUser.jsp" class="nav-link">In
														Different Branch</a></li>
												<li><a href="loginUser.jsp" class="nav-link">In
														Diff Bank</a></li>
								...
								<li class="social"><a href="#" class="nav-link"><span
		...
		<div class="site-blocks-cover overlay"
			style="background-image: url(images/img_1.jpg);" data-aos="fade">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-8 blog-content">
						...
						<p class="lead">Lorem ipsum dolor sit amet, consectetur
							adipisicing elit. Assumenda nihil aspernatur nemo sunt, qui,
							harum repudiandae quisquam eaque dolore itaque quod tenetur quo
							quos labore?</p>
						...
						<p>Accusamus, temporibus, ullam. Voluptate consectetur laborum
							...
							error omnis consequatur iste deleniti illum, dolorum odit.</p>
						...
						<p>Amet sint explicabo maxime accusantium qui dicta enim quia,
							...
							fugit. Sint, delectus molestiae. Totam.</p>
